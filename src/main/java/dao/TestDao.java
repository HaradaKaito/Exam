...
public class TestDao extends Dao {
    ...
    public List<Test> getAllTests() throws Exception {
        ...
        PreparedStatement st = con.prepareStatement(
            ...
            "FROM TEST T LEFT JOIN STUDENT S ON T.STUDENT_NO = S.NO " +
            "ORDER BY T.SCHOOL, T.NO"
        );

        ResultSet rs = st.executeQuery();
        List<Test> list = postFilter(rs, null, null);
        rs.close();
        st.close();
        con.close();
        return list;
    ...
    public List<Test> getScoresByStudent(String studentId) throws Exception {
        ...
        PreparedStatement st = con.prepareStatement(
            ...
            "WHERE T.STUDENT_NO = ? ORDER BY T.NO"
        );
    ...
    public List<Test> filter(int entYear, String classNum, Subject subject, int num, School school) throws Exception {
        ...
        PreparedStatement st = con.prepareStatement(
            ...
            "AND T.SUBJECT_CD = ? AND T.NO = ? ORDER BY S.NO"
        );
