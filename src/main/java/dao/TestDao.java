...
public class TestDao extends Dao {
     ...
     * ResultSet → List<Test>
     */
    private List<Test> postFilter(ResultSet rs, School school, Subject subject) throws Exception {
